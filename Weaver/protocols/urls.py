...
urlpatterns = [
    ...
    path('component/edit/<uuid:pk>/', login_required(ComponentEdit.as_view(), redirect_field_name='next'), name='component_edit'),
    ...
    path('reactive/edit/<uuid:pk>/', login_required(ReactiveEdit.as_view(), redirect_field_name='next'), name='reactive_edit'),
]
